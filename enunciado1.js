console.log("Enunciado 1 Cargado.");
document.getElementById('btnCalculadorIMC').addEventListener('click', function () {
...
*/
function calculateBMI(masa = 0, estatura = 0) {
  if (masa == 0) {
...
function showBMIResult(imc_calculado) {
  ...
  switch (true) {
    case (imc_calculado <= 18.5):
      clasificacion = "⚠️ Peso bajo. Cuidate!"
      break;
    case (imc_calculado < 25):
      clasificacion = "✅ Normal. No aflojes"
      break;
    case (imc_calculado < 30):
